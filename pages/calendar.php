...
<body>
    ...
    <main class="main">
        <div class="container">
            ...
            <section class="hero">
                <h1 style="color: var(--primary-color); font-size: 2rem; margin-bottom: 0.5rem;">📅 Quando você gostaria de ser atendido?</h1>
                <p class="subtitle" style="color: var(--text-light); font-size: 1.1rem;">Escolha o dia e horário mais convenientes para você</p>
            </section>
            ...
            <div style="display: grid; grid-template-columns: 1fr; gap: 2rem; max-width: 1000px; margin: 0 auto;">
                ...
                <section class="card">
                    <div style="border-left: 4px solid var(--primary-color); padding-left: 1rem; margin-bottom: 1.5rem;">
                        <h2 style="color: var(--primary-color); margin-bottom: 0.5rem; font-size: 1.3rem;">Selecione uma Data</h2>
                        <p style="color: var(--text-light); margin: 0;">Atendemos de segunda a sexta-feira</p>
                    </div>
                ...
                <section class="card" style="background: linear-gradient(to bottom, rgba(139, 154, 139, 0.05), white);">
                    <div style="border-left: 4px solid var(--success-color); padding-left: 1rem; margin-bottom: 1.5rem;">
                        <h2 style="color: var(--success-color); margin-bottom: 0.5rem; font-size: 1.3rem;">Escolha seu Horário</h2>
                        <p style="color: var(--text-light); margin: 0;">Data selecionada: <strong><?= date('d/m/Y', strtotime($selected_date)) ?></strong></p>
                    </div>
