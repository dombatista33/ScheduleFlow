...
<body>
    ...
    <main class="main">
        <div class="container">
            ...
            <div style="max-width: 800px; margin: 2rem auto 3rem;">
                <div style="display: flex; justify-content: space-between; align-items: center; position: relative;">
                    ...
                    <div style="display: flex; flex-direction: column; align-items: center; z-index: 1;">
                        ...
                        <span style="font-size: 0.85rem; font-weight: 600; color: var(--primary-color);">Escolha o Horário</span>
                    </div>
            ...
            <section class="hero">
                <h1 style="color: var(--primary-color); font-size: 2rem; margin-bottom: 0.5rem;">📅 Agende sua Sessão</h1>
                <p class="subtitle" style="color: var(--text-light); font-size: 1.1rem;">Siga os passos abaixo para escolher data e horário</p>
            </section>
            ...
            <div style="display: grid; grid-template-columns: 1fr; gap: 2rem; max-width: 1000px; margin: 0 auto;">
                ...
                <section class="card">
                    <div style="border-left: 4px solid var(--primary-color); padding-left: 1rem; margin-bottom: 1.5rem;">
                        <h2 style="color: var(--primary-color); margin-bottom: 0.5rem; font-size: 1.3rem;">1. Data da Sessão</h2>
                        <p style="color: var(--text-dark); margin: 0.5rem 0; font-weight: 500;">Selecione a Data Disponível:</p>
                        <p style="color: var(--text-light); margin: 0; line-height: 1.6;">O calendário mostra os dias em que há vagas. Clique na data desejada para prosseguir.</p>
                        <p style="color: var(--warning-color); margin: 0.75rem 0 0 0; font-size: 0.95rem; display: flex; align-items: center; gap: 0.5rem;">
                            <span>⚠️</span>
                            <strong>Atenção:</strong> Datas sem horários disponíveis não estarão ativas para clique.
                        </p>
                    </div>
                ...
                <section class="card" style="background: linear-gradient(to bottom, rgba(139, 154, 139, 0.05), white);">
                    <div style="border-left: 4px solid var(--success-color); padding-left: 1rem; margin-bottom: 1.5rem;">
                        <h2 style="color: var(--success-color); margin-bottom: 0.5rem; font-size: 1.3rem;">2. Horário da Sessão</h2>
                        <p style="color: var(--text-dark); margin: 0.5rem 0; font-weight: 500;">Escolha um Horário Livre:</p>
                        <p style="color: var(--text-light); margin: 0; line-height: 1.6;">Data selecionada: <strong><?= date('d/m/Y', strtotime($selected_date)) ?></strong></p>
                        <p style="color: var(--text-light); margin: 0.5rem 0 0 0; line-height: 1.6;">Verifique a lista e clique na hora que não estiver marcada como 'Ocupado'.</p>
                        <p style="color: var(--text-light); margin: 0.5rem 0 0 0; font-size: 0.95rem; font-style: italic;">Se um horário estiver esgotado, ele será exibido, mas não será clicável.</p>
                    </div>
